...
&&  mkdir -p /app/uploads \
&&  chown rocketchat:root /app/uploads && chmod g+rwx /app/uploads

VOLUME /app/uploads

# gpg: key 4FD08104: public key "Rocket.Chat Buildmaster <buildmaster@rocket.chat>" imported
#RUN gpg --batch --keyserver hkp://keyserver.ubuntu.com:80 --recv 9DA31620334BD75D9DCB49F368818C72E52529D4
...
&&  chown -R rocketchat:root /app && chmod g+rwx /app
